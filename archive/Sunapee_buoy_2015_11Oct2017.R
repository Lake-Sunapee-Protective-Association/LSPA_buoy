...
#* PREVIOUS VERSION: 'Sunapee_buoy_2014-2016_07Aug2017.R'        *
#*****************************************************************
...
#bring in 2015 LMP data for comparison
setwd('C:/Users/steeleb/Dropbox/Lake Sunapee/long term Sunapee data/raw data/LMP files/LMP 2015')
LMP2015 <- read.xls('LMPDO_2015.xlsx', sheet='LMPDO', header=T)
#format date
LMP2015$DATE <- as.Date(LMP2015$DATE, format='%Y-%m-%d')
