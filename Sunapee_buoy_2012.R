...
buoy2012_L1 <- buoy2012_L1 %>% 
  mutate(do_flag = case_when(datetime == as.POSIXct('2012-04-18 10:00', tz='UTC') ~ '1.5w',
                             datetime == as.POSIXct('2012-10-18 10:00', tz='UTC') ~ '1.5w',
                             TRUE ~ ''))
...
buoy2012_L1 <- buoy2012_L1 %>% 
  mutate(do_flag = case_when(location == 'offline' ~ '',
                             TRUE ~ do_flag))
