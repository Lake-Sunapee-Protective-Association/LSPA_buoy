...
buoy2011_L1 <- buoy2011_L1 %>% 
  mutate(do_flag = case_when(datetime == as.POSIXct('2011-04-01 10:40', tz='UTC') ~ '1.5wp',
                             datetime == as.POSIXct('2011-10-26 10:50', tz='UTC') ~ '1.5wp',
                             TRUE ~ ''))
...
buoy2011_L1 <-buoy2011_L1 %>% 
  mutate_at(vars(do_flag, PAR_flag),
