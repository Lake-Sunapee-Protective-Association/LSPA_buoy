# example initiatlization for 'insitu_qaqc.R' script
...
download.file('https://github.com/FLARE-forecast/SUNP-data/blob/sunp-buoy-data/SUNP_buoy_wq.csv?raw=true', 'C:/Users/wwoel/Desktop/SUNP-forecast/data_raw/buoy-data/SUNP_buoy_wq.csv')
