...
#exo actually not functioning until Jun 29 visit
buoy2021b_wq_L1 <- buoy2021b_wq_L1 %>% 
  mutate_at(vars(all_of(exo)),
...
#bga rfu
ggplot(buoy2021b_wq_L1, aes(x = datetime, y = BGAPC_RFU)) +
  geom_point() +
  final_theme
