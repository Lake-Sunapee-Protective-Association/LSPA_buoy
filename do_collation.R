...
do2007 <- read_csv('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/buoy data/data/all sensors/L1/2007_do_L1.csv',
                    col_types = 'Tcnnnc') %>% 
  filter(datetime >= as.POSIXct('2007-01-01', tz='UTC') & datetime < as.POSIXct('2008-01-01', tz='UTC'))
str(do2007)

do2008 <- read_csv('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/buoy data/data/all sensors/L1/2008_do_L1.csv',
                   col_types = 'Tcnnnc') %>% 
  filter(datetime >= as.POSIXct('2008-01-01', tz='UTC') & datetime < as.POSIXct('2009-01-01', tz='UTC'))
str(do2008)

do2009 <- read_csv('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/buoy data/data/all sensors/L1/2009_do_L1.csv',
                   col_types = 'Tcnnnc') %>% 
  filter(datetime >= as.POSIXct('2009-01-01', tz='UTC') & datetime < as.POSIXct('2010-01-01', tz='UTC'))
str(do2009)

do2010 <- read_csv('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/buoy data/data/all sensors/L1/2010_do_L1.csv',
                   col_types = 'Tcnnnc') %>% 
  filter(datetime >= as.POSIXct('2010-01-01', tz='UTC') & datetime < as.POSIXct('2011-01-01', tz='UTC'))
str(do2010)

do2011 <- read_csv('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/buoy data/data/all sensors/L1/2011_do_L1.csv',
                   col_types = 'Tcnnnc') %>% 
  filter(datetime >= as.POSIXct('2011-01-01', tz='UTC') & datetime < as.POSIXct('2012-01-01', tz='UTC'))
str(do2011)

do2012 <- read_csv('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/buoy data/data/all sensors/L1/2012_do_L1.csv',
                   col_types = 'Tcnnnc') %>% 
  filter(datetime >= as.POSIXct('2012-01-01', tz='UTC') & datetime < as.POSIXct('2013-01-01', tz='UTC'))
str(do2012)

do2013 <- read_csv('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/buoy data/data/all sensors/L1/2013_do_L1.csv',
                   col_types = 'Tcnnnnnncc') %>% 
  filter(datetime >= as.POSIXct('2013-01-01', tz='UTC') & datetime < as.POSIXct('2014-01-01', tz='UTC'))
str(do2013)

do2014 <- read_csv('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/buoy data/data/all sensors/L1/2014_do_L1.csv',
                   col_types = 'Tcnnnnnncc') %>% 
  filter(datetime >= as.POSIXct('2014-01-01', tz='UTC') & datetime < as.POSIXct('2015-01-01', tz='UTC'))
str(do2014)

do2015 <- read_csv('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/buoy data/data/all sensors/L1/2015_do_L1.csv',
                   col_types = 'Tnnnnnnccc') %>% 
  filter(datetime >= as.POSIXct('2015-01-01', tz='UTC') & datetime < as.POSIXct('2016-01-01', tz='UTC'))
str(do2015)

do2016 <- read_csv('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/buoy data/data/all sensors/L1/2016_do_L1.csv',
                   col_types = 'Tnnnnnnccc') %>% 
  filter(datetime >= as.POSIXct('2016-01-01', tz='UTC') & datetime < as.POSIXct('2017-01-01', tz='UTC'))
str(do2016)

do2017 <- read_csv('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/buoy data/data/all sensors/L1/2017_do_L1.csv',
                   col_types = 'Tnnnnnnccc') %>% 
...
buoy_record_do %>% 
  ...
  write_csv(., 'C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/buoy data/data/all sensors/L1/2007-2017_do_L1.csv')
